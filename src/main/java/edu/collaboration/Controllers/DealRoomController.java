...
import edu.collaboration.services.GovernanceEngineAPI;
...
public class DealRoomController {
    ...
    private int currentUserId; // 1 entrepreneur, 2 investor typically, passed from caller
    ...
    public void initData(Investment inv, Project proj, int loggedInUserId) {
        ...
        try {
            ...
            currentCollaboration = cs.getCollaborationByInvestment(proj.getProjectId(), inv.getInvestorId());
            ...
            if (currentCollaboration != null || "ACCEPTED".equalsIgnoreCase(inv.getStatus())) {
                ...
                if (currentCollaboration == null) {
                    ...
                    Collaboration newCollab = new Collaboration(0, proj.getProjectId(), inv.getInvestorId(), null,
                            "ACTIVE", 100.0, 0.0);
    ...
    private void setupNegotiationMode() {
        ...
        if (actionButtonsBox != null) {
            ...
            if ("REFUSED".equalsIgnoreCase(currentInvestment.getStatus())) {
                ...
                if (currentUserId == currentProject.getEntrepreneurId()) {
    ...
    void editOffer() {
        ...
        try {
            ...
            // Save to DB
            edu.collaboration.services.InvestmentService is = new edu.collaboration.services.InvestmentService();
    ...
    private void loadMessages(boolean isActive) {
        ...
        for (CollaborationMessage m : msgs) {
            String role = (m.getSenderId() == currentProject.getEntrepreneurId()) ? "Entrepreneur" : "Investor";
            String prefix = (m.getSenderId() == currentUserId) ? "You (" + role + "): " : role + ": ";
    ...
    void sendMessage() {
        ...
        try {
            cs.sendMessage(cm);
            String role = (currentUserId == currentProject.getEntrepreneurId()) ? "Entrepreneur" : "Investor";
