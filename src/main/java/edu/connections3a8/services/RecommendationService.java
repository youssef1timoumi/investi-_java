...
public class RecommendationService {
     ...
     */
    public List<Course> getRecommendationsForUser(int userId, int limit) throws SQLException {
     ...
     */
    private List<Long> getRecommendationsBasedOnHistory(int userId, int limit) throws SQLException {
     ...
     */
    private List<Long> getCollaborativeRecommendations(int userId, int limit) throws SQLException {
        ...
        for (int i = 0; i < similarUsers.size(); i++) {
            coursePst.setInt(i + 1, similarUsers.get(i));
        }
     ...
     */
    private List<Long> getPopularInPreferredCategories(int userId, int limit) throws SQLException {
     ...
     */
    private Set<Long> getUserCompletedCourses(int userId) throws SQLException {
     ...
     */
    public Map<String, Double> getRecommendationScores(int userId, long courseId) throws SQLException {
    ...
    private double calculateCategoryMatchScore(int userId, long courseId) throws SQLException {
        // Implementation for category matching
        return 0.0; // Placeholder
    }
    
    private double calculateDifficultyMatchScore(int userId, long courseId) throws SQLException {
    ...
    private double calculateCollaborativeScore(int userId, long courseId) throws SQLException {
