...
public class InscriptionServiceTest {
    ...
    private int createTestEvent() throws SQLException {
        Evenement event = new Evenement(
                1,
                "Test Event for Inscription",
                "Test content",
                "Test location",
        ...
        return events.get(events.size() - 1).getIdEvenement();
    }
    ...
    public void testGetInscriptionById() {
        ...
        try {
            ...
            assertEquals(idTestEvent, recuperee.getIdEvenement());
